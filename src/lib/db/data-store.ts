...
export const INITIAL_COMPANY_SETTINGS: CompanySettings = {
  ...
  email: 'info@fastengineeringsolutions.com',
  address: 'Industrial Estate, Sector H-9, Islamabad / Lahore, Pakistan',
  latitude: 31.5204,
  longitude: 74.3587,
  working_hours: 'Monday - Saturday: 08:00 AM - 07:00 PM (Emergency 24/7)',
  social_links: {
    facebook: 'https://facebook.com/fastengineeringsolutions',
    linkedin: 'https://linkedin.com/company/fastengineeringsolutions',
    twitter: 'https://twitter.com/fastengsolutions',
  },
